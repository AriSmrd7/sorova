...
>
  <head>
    ...
    <title>Sorova - Login</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('new-assets') }}/img/favicon/favicon.ico" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('new-assets') }}/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Sorova</span>
                </a>
              </div>
              <!-- /Logo -->
              <p class="mb-0"><strong>Selamat datang di Sorova.</strong></p>
              <p class="mb-3 text-muted">Silahkan login terlebih dahulu.</p>
              ...
              <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input id="password"  aria-describedby="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
